...
import '../../../home/presentation/pages/healthcare_home_page.dart';
...
class _PatientProfilePageState extends State<PatientProfilePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      String? token;
      try {
        token = Provider.of<AuthController>(context, listen: false).token;
      } catch (_) {}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: profileController.isLoading
          ...
          : RefreshIndicator(
              onRefresh: () => profileController.fetchProfile(token),
